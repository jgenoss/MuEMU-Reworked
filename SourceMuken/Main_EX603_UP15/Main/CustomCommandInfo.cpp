...
void CCustomCommandInfo::DrawCommandWindow()
{
	...
	//pDrawGUFULL(0x9333, StartX + 5, StartY - 5, 350, 250, 0, 0, 1, 1, 1, 1, 0.0); // MENU


	// ----
	//gInterface.DrawFormat(eGold, (int)StartX + 10, (int)StartBody + 10, 210, 3, "Commands");
	gInterface.DrawFormat(eGold, (int)StartX + 110, (int)StartBody + 10, 210, 3, "Hướng Dẫn Chơi Game");

	CustomFont.DrawMultipleColor(CustomFont.FontSize18, (int)StartX + 150, (int)StartY + 10, 0x0, 0, 0, 0, "Lenh Trong Game");
	...
	gInterface.DrawFormat(eGold,  StartX + 125, StartBody + 47, 52, 1,"Kết Qủa:");

	gInterface.DrawFormat(eGold,  StartX + 210, StartBody + 47, 52, 1,"Tex:");
