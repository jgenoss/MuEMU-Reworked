									...
									if ( *(DWORD *)(v62 + 80) != 3 || *(BYTE *)0x8793384 || pCheckMouseOver(v83, v88, v71, v76) )
									{
										...
										//-- DrawSkill Bar Slot 5
											...
											while ( v68 < 5 )
											{
												...
												{
												case 0:
													v84 = Return2X(xInterface + TransForX( 347 ));
													break;
												case 1:
													v84 = Return2X(xInterface + TransForX( 369 ));
													break;
												case 2:
													v84 = Return2X(xInterface + TransForX( 392 ));
													break;
												case 3:
													v84 = Return2X(xInterface + TransForX( 414 ));
													break;
												case 4:
													v84 = Return2X(xInterface + TransForX( 438 ));
													break;
												}
...
void sub_813740(int This)
{
	...
	if ( (signed int)*(BYTE *)(oUserObjectStruct + 118) > 0 )
	{
		...
		for ( i = 0; i < 5; ++i )
		{
			...
			{
			case 0:
				x = Return2X(xInterface + TransForX( (TypeSlot == 4) ? 333.2999878 : 347));
				break;
			case 1:
				x = Return2X(xInterface + TransForX( (TypeSlot == 4) ? 355.6000061 : 369));
				break;
			case 2:
				x = Return2X(xInterface + TransForX( (TypeSlot == 4) ? 379 : 392));
				break;
			case 3:
				x = Return2X(xInterface + TransForX( (TypeSlot == 4) ? 400.5 : 414));
				break;
			case 4:
				x = Return2X(xInterface + TransForX( (TypeSlot == 4) ? 422.5 : 436));
				break;
			}
		...
		if ( v9 && *(BYTE *)(v9 + 55) != 3 )
		{
			//SkillView(This, *(BYTE *)(*(DWORD *)0x7BC4F04 + 50), Return2X(xInterface + TransForX((TypeSlot == 4) ? 305.35 : 306 )), (TypeSlot == 4) ? 440.5 : 444, wSkillSelect, hSkillSelect, 0, (TypeSlot == 4) ? 112.5 : 100, (TypeSlot == 4) ? 99.99998639285714 : 89.2857); //-- Slot en Uso
		    SkillView(This, *(BYTE *)(*(DWORD *)0x7BC4F04 + 50), Return2X(xInterface + TransForX((TypeSlot == 4) ? 305.35 : 306 )), (TypeSlot == 4) ? 440.5 : 430, wSkillSelect, hSkillSelect, 0, (TypeSlot == 4) ? 112.5 : 100, (TypeSlot == 4) ? 99.99998639285714 : 89.2857); //-- Slot en Uso
		}
	}
}
...
int ItemDrawPotion(int *This)
{
	...
	v12 = 0;
	if ( v10 )
		v5 = CHotKeyQStateItem_CHotKeyQStateItem(v10, Return2X(xInterface + TransForX( 188 )), 442.5, Return2X(xInterface + TransForX( 198 )), 455);
	else
		v5 = 0;
	v12 = -1;
	v11 = v5;
	...
	v12 = 1;
	if ( v9 )
		v4 = CHotKeyWStateItem_CHotKeyWStateItem(v9, Return2X(xInterface + TransForX( 214 )), 442.5, Return2X(xInterface + TransForX( 225 )), 455);
	else
		v4 = 0;
	v12 = -1;
	v11 = v4;
	...
	v12 = 2;
	if ( v8 )
		v3 = CHotKeyEStateItem_CHotKeyEStateItem(v8, Return2X(xInterface + TransForX( 240 )), 442.5, Return2X(xInterface + TransForX( 251 )), 455);
	else
		v3 = 0;
	v12 = -1;
	v11 = v3;
	...
	v12 = 3;
	if ( v7 )
		v2 = CHotKeyRStateItem_CHotKeyRStateItem(v7, Return2X(xInterface + TransForX( 268 )), 442.5, Return2X(xInterface + TransForX( 278 )), 455);
	else
		v2 = 0;
	v12 = -1;
	v11 = v2;
...
void SDCurrentLive( )
{
	...
	YSDCoord = ( Type == 4 ) ? TransForY( 464.675 ) : TransForY( 464.875 ) ;
	...
	RenderBitmap(31300, XSDCoord + TransForX(( Type == 4 ) ? 184 : 184 ) , YSDCoord, nWidth +55, Height -5, 0.0, 0.0, XSDScale, 1.0, 0, 0, 0.0);
...
//--
	...
	//pDrawText(pTextThis(), Return2X(XSDCoord + TransForX(50)), ReturnY(TransForY(440)), String, Return2X(TransForX(63.75+ 107.25)), 0, (LPINT)3, 0);
	pDrawText(pTextThis(), Return2X(XSDCoord + TransForX(117.25)), ReturnY(TransForY(440)), String, Return2X(TransForX(63.75)), 0, (LPINT)3, 0);
...
void BPCurrentLive( )
{
    ...
    YBPCoord = ( Type == 4 ) ? TransForY( 464.675 ) : TransForY( 464.875 ) ;
	...
	nXBPCoord = XBPCoord + TransForX(( Type == 4 ) ? 349 : 349 ) + Width - nWidth; //-- XBPCoord
	//--
	//RenderBitmap(31299, nXBPCoord, YBPCoord, nWidth, Height, XBPDropMove, 0.0, XBPScale, 1.0, 0, 0, 0.0);
    RenderBitmap(31299, nXBPCoord, YBPCoord, nWidth +57, Height -5, XBPDropMove, 0.0, XBPScale, 1.0, 0, 0, 0.0);
	...
	//pDrawText(pTextThis(), Return2X(XBPCoord + TransForX(415)), ReturnY(TransForY(440)), String, Return2X(TransForX(63.75 + 107.25)), 0, (LPINT)3, 0);
...
//-- HP
	...
	RenderBitmap(51502, nRenderX +14, TransForY(408.125), TransForX(63.75), TransForY(63.75), 0.0, 0.0, nDropScale2, nDropScale1, 0, 0, 0);

	if ( pCheckEffectPlayer((DWORD *)(*(DWORD *)0x7BC4F04 + 1260), 55) )
	{
		RenderBitmap(31297, nRenderX +14, nCoord, TransForX(63.75), nHeight, 0.0, nDropMoveY, nDropScale2, nScale, 0, 0, 0);
	}
	else
	{
		RenderBitmap(31298, nRenderX +14, nCoord, TransForX(63.75), nHeight, 0.0, nDropMoveY, nDropScale2, nScale, 0, 0, 0);
	}
//-- MP
	nDropScale1 = (gProtect.m_MainInfo.CustomInterfaceType == 4) ? 0.6760000587 : 0.986000061 ;
	nDropScale2 = (gProtect.m_MainInfo.CustomInterfaceType == 4) ? 0.6460000873 : 0.986000061 ;
	...
	RenderBitmap(51501, nRenderX -8, TransForY(408.125), TransForX(63.75), TransForY(63.75), 0.0, 0.0, nDropScale2, nDropScale1, 0, 0, 0);
	// ---x
	RenderBitmap(31296, nRenderX -8, nCoord, TransForX(63.75), nHeight, 0.0, nDropMoveY, nDropScale2, nScale, 0, 0, 0); 

//-- Interface
	RenderBitmap(31293, x, y, Width, TransForY( 68 ), 0.0, 0.0, 0.9129598141, 0.8629598618, 0, 0, 0.0);
