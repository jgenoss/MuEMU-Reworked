...
void __declspec(naked) NewItemRingPedan()
{
	...
	if (ITEMID >= 6664 && ITEMID <= 6665
		|| ITEMID == 6836 //ID Ring Va Pedan
		|| ITEMID == 6837 //ID Ring Va Pedan
		|| ITEMID == 6838 //ID Ring Va Pedan
		|| ITEMID == 6839 //ID Ring Va Pedan
		|| ITEMID == 6840 //ID Ring Va Pedan
		|| ITEMID == 6841 //ID Ring Va Pedan

		|| ITEMID == 6842 //ID Ring Va Pedan
		|| ITEMID == 6843 //ID Ring Va Pedan
		|| ITEMID == 6844 //ID Ring Va Pedan
		|| ITEMID == 6845 //ID Ring Va Pedan
		|| ITEMID == 6846 //ID Ring Va Pedan
		|| ITEMID == 6847 //ID Ring Va Pedan
...
{
	LoadItemModel(7780, "Item\\Flag\\", "Flag100", -1);
	((void(*)())0x00617D30)();
...
{
	gInterface.ChoLoadImage = 1;
	gInterface.LoadImageSauKhiVaoGame();

	LoadItemTexture(7780, "Item\\Flag\\", "Flag100", -1);
	((void(*)())0x0061AED0)();
