...
void CCapeAnimation::DrawViewPort(DWORD ObjectPointer, DWORD ObjectModel, DWORD a3)
{
	...
	if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan > 0 && gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan <7)
	{
		vec3_t Color;
		Vector(1.0, 1.0, 1.0, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >= 6) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan+5, 2.3f, 2.3f, Color,1);
		if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >= 5) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan+4, 1.9f, 1.9f, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >= 4) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan+3, 1.6f, 1.6f, Color,1);
		if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >= 3) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan+2, 1.3f, 1.3f, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >= 2) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan+1, 1.0f, 1.0f, Color,1);
		if(gCustomRankUser.m_Data[Object->aIndex].m_CapDoHonHoan >=1) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan, 0.8f, 0.8f, Color);
