...
namespace ASM {
	enum Opcode : BYTE {
		JMP = 0xE9, // salto relativo
		JE = 0x74, // salto si igual
		JNE = 0x75, // salto si no igual
		JGE = 0x7D, // salto >=
		NOP = 0x90, // no operación
		CALL = 0xE8, // llamada relativa
		CALLI = 0xFF, // llamada indirecta
		PUSH = 0x68  // push inmediato
	};
}
...
// Predefined colors
	struct Colors {
		...
		// ============================================
		// COLORES ADICIONALES PARA UI/INTERFACES
		// ============================================

		// Grises adicionales
		static constexpr DWORD LightGray = Color4f(192, 192, 192, 255);
		static constexpr DWORD LightGray150 = Color4f(192, 192, 192, 150);
		static constexpr DWORD DarkGray = Color4f(128, 128, 128, 255);
		static constexpr DWORD DarkGray150 = Color4f(128, 128, 128, 150);
		static constexpr DWORD VeryDarkGray = Color4f(64, 64, 64, 255);
		static constexpr DWORD Black = Color4f(0, 0, 0, 255);
		static constexpr DWORD Black200 = Color4f(0, 0, 0, 200);

		// Verdes adicionales
		static constexpr DWORD Green = Color4f(0, 255, 0, 255);
		static constexpr DWORD Green150 = Color4f(0, 255, 0, 150);
		static constexpr DWORD DarkGreen = Color4f(0, 180, 0, 255);
		static constexpr DWORD LimeGreen = Color4f(50, 205, 50, 255);

		// Rojos adicionales
		static constexpr DWORD Red150 = Color4f(225, 0, 0, 150);
		static constexpr DWORD DarkRed = Color4f(180, 0, 0, 255);
		static constexpr DWORD Crimson = Color4f(220, 20, 60, 255);

		// Azules adicionales
		static constexpr DWORD Blue150 = Color4f(36, 242, 252, 150);
		static constexpr DWORD DarkBlue = Color4f(0, 0, 180, 255);
		static constexpr DWORD Navy = Color4f(0, 0, 128, 255);
		static constexpr DWORD SkyBlue = Color4f(135, 206, 235, 255);

		// Violetas/Púrpuras
		static constexpr DWORD Purple = Color4f(160, 32, 240, 255);
		static constexpr DWORD Purple150 = Color4f(160, 32, 240, 150);
		static constexpr DWORD Violet = Color4f(138, 43, 226, 255);
		static constexpr DWORD Magenta = Color4f(255, 0, 255, 255);

		// Otros colores útiles
		static constexpr DWORD Cyan = Color4f(0, 255, 255, 255);
		static constexpr DWORD Cyan150 = Color4f(0, 255, 255, 150);
		static constexpr DWORD Pink = Color4f(255, 192, 203, 255);
		static constexpr DWORD Silver = Color4f(192, 192, 192, 255);
		static constexpr DWORD Bronze = Color4f(205, 127, 50, 255);
	};
	...
	enum ColorMacro
	{
		...
		// Grises adicionales
		eLightGray = Color4f(192, 192, 192, 255),
		eLightGray150 = Color4f(192, 192, 192, 150),
		eDarkGray = Color4f(128, 128, 128, 255),
		eDarkGray150 = Color4f(128, 128, 128, 150),
		eVeryDarkGray = Color4f(64, 64, 64, 255),
		eBlack = Color4f(0, 0, 0, 255),
		eBlack200 = Color4f(0, 0, 0, 200),

		// Verdes adicionales
		eGreen = Color4f(0, 255, 0, 255),
		eGreen150 = Color4f(0, 255, 0, 150),
		eDarkGreen = Color4f(0, 180, 0, 255),
		eLimeGreen = Color4f(50, 205, 50, 255),

		// Rojos adicionales
		eRed150 = Color4f(225, 0, 0, 150),
		eDarkRed = Color4f(180, 0, 0, 255),
		eCrimson = Color4f(220, 20, 60, 255),

		// Azules adicionales
		eBlue150 = Color4f(36, 242, 252, 150),
		eDarkBlue = Color4f(0, 0, 180, 255),
		eNavy = Color4f(0, 0, 128, 255),
		eSkyBlue = Color4f(135, 206, 235, 255),

		// Violetas/Púrpuras
		ePurple = Color4f(160, 32, 240, 255),
		ePurple150 = Color4f(160, 32, 240, 150),
		eViolet = Color4f(138, 43, 226, 255),
		eMagenta = Color4f(255, 0, 255, 255),

		// Otros colores útiles
		eCyan = Color4f(0, 255, 255, 255),
		eCyan150 = Color4f(0, 255, 255, 150),
		ePink = Color4f(255, 192, 203, 255),
		eSilver = Color4f(192, 192, 192, 255),
		eBronze = Color4f(205, 127, 50, 255),
	};
