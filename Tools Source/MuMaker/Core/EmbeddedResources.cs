...
namespace MuMaker.Core
{
    ...
    internal sealed class EmbeddedResources
    {
        ...
        // CORRECTED mapping based on actual form usage
        internal static ResourceManager smethod_3() => GetResourceManager();
        internal static CultureInfo smethod_4() => GetCulture();
        internal static Bitmap smethod_5() => GetAccountMakerMain();
        internal static Bitmap smethod_6() => GetFindeMakerMain();
        internal static Bitmap smethod_7() => GetGuildMakerMain();
        internal static Bitmap smethod_8() => GetItemMakerMain();
        internal static Bitmap smethod_9() => GetSkillMakerMain();
        internal static Bitmap smethod_10() => GetBotonAccountMaker();      // BotonAccountMaker background
        internal static Bitmap smethod_11() => GetBotonAccountMakerDown();  // BotonAccountMaker pressed
        internal static Bitmap smethod_12() => GetPJMakerMain();            // Used for various button backgrounds
        internal static Bitmap smethod_13() => GetSearchMakerMain();
        internal static Bitmap smethod_14() => GetConfig();                 // BotonConfig background
        internal static Bitmap smethod_15() => GetMainNew();
        internal static Bitmap smethod_16() => GetBotonFinderMaker();       // BotonFinderMaker background
        internal static Bitmap smethod_17() => GetBotonFinderMakerDown();   // BotonFinderMaker pressed
        internal static Bitmap smethod_18() => GetBotonGuildMaker();        // BotonGuildMaker background
        internal static Bitmap smethod_19() => GetBotonGuildMakerDown();    // BotonGuildMaker pressed
        internal static Bitmap smethod_20() => GetBotonItemMaker();         // BotonItemMaker background
        internal static Bitmap smethod_21() => GetBotonItemMakerDown();     // BotonItemMaker pressed
        internal static Bitmap smethod_22() => GetOK();
        internal static Bitmap smethod_23() => GetOKDown();
        internal static Bitmap smethod_24() => GetBotonMoveMaker();         // BotonMoveMaker background
        internal static Bitmap smethod_25() => GetBotonMoveMakerDown();     // BotonMoveMaker pressed
        internal static Bitmap smethod_26() => GetCerrar();                 // Close button (various forms)
        internal static Bitmap smethod_27() => GetCerrarDown();
        internal static Bitmap smethod_28() => GetClose();
        internal static Bitmap smethod_29() => GetBotonSkillMaker();        // BotonSkillMaker background
        internal static Bitmap smethod_30() => GetBotonSkillMakerDown();    // BotonSkillMaker pressed
        internal static Bitmap smethod_31() => GetBotonSQLMaker();          // BotonSQLMaker background
        internal static Bitmap smethod_32() => GetBotonSQLMakerDown();      // BotonSQLMaker pressed
        internal static Bitmap smethod_33() => GetBotonAccountMakerDown();
        internal static Bitmap smethod_34() => GetBotonItemMaker();
        internal static Bitmap smethod_35() => GetBotonItemMakerDown();
        internal static Bitmap smethod_36() => GetBotonGuildMaker();
        internal static Bitmap smethod_37() => GetBotonGuildMakerDown();
        internal static Bitmap smethod_38() => GetCasilla();                // Slot/cell background (V1-V120)
        internal static Bitmap smethod_39() => GetClose();                  // Cerrar/Close button
        internal static Bitmap smethod_40() => GetCloseDown();              // Cerrar/Close pressed
        internal static Bitmap smethod_41() => GetBotonSkillMakerDown();
        internal static Bitmap smethod_42() => GetBotonMoveMaker();
        internal static Bitmap smethod_43() => GetBotonMoveMakerDown();
        internal static Bitmap smethod_44() => GetBotonConfigMaker();       // BotonConfig/Cerrar
        internal static Bitmap smethod_45() => GetBotonConfigMakerDown();
        internal static Bitmap smethod_46() => GetBotonSQLMaker();
        internal static Bitmap smethod_47() => GetBotonSQLMakerDown();
        internal static Bitmap smethod_48() => GetConnect();                // Connect button
        internal static Bitmap smethod_49() => GetConnectDown();
        internal static Bitmap smethod_50() => GetCreate();                 // CreateReset, CreateGuild buttons
        internal static Bitmap smethod_51() => GetCreateDown();
        internal static Bitmap smethod_52() => GetBotonReserved();
        internal static Bitmap smethod_53() => GetBotonBuscar();            // Buscar/Search button
        internal static Bitmap smethod_54() => GetBotonBuscarDown();        // Buscar pressed
        internal static Bitmap smethod_55() => GetBotonZen();
        internal static Bitmap smethod_56() => GetBotonZenDown();
        internal static Bitmap smethod_57() => GetConnect();
        internal static Bitmap smethod_58() => GetConnectDown();
        internal static Bitmap smethod_59() => GetCreate();
        internal static Bitmap smethod_60() => GetCreateDown();
        internal static Bitmap smethod_61() => GetDelete();
        internal static Bitmap smethod_62() => GetDeleteDown();
        internal static Bitmap smethod_63() => GetReload();
        internal static Bitmap smethod_64() => GetReloadDown();
        internal static Bitmap smethod_65() => GetManual();
        internal static Bitmap smethod_66() => GetManualDown();
        internal static Bitmap smethod_67() => GetMinimizar();
        internal static Bitmap smethod_68() => GetMinimizarDown();
        internal static Bitmap smethod_69() => GetVault();
        internal static Bitmap smethod_70() => GetVaultDown();
        internal static Bitmap smethod_71() => GetInvent01();
        internal static Bitmap smethod_72() => GetInvent01Down();
        internal static Bitmap smethod_73() => GetInvent02();
        internal static Bitmap smethod_74() => GetInvent02Down();
        internal static Bitmap smethod_75() => GetWeapons();
        internal static Bitmap smethod_76() => GetArmors();
        internal static Bitmap smethod_77() => GetHelms();
        internal static Bitmap smethod_78() => GetGloves();
        internal static Bitmap smethod_79() => GetPants();
        internal static Bitmap smethod_80() => GetBoots();
        internal static Bitmap smethod_81() => GetLoging();                 // LogingSQL background
        internal static Bitmap smethod_82() => GetMainNew();                // Main form background
        internal static Bitmap smethod_83() => GetManual();                 // BotonHelp background
        internal static Bitmap smethod_84() => GetPendants();
        internal static Bitmap smethod_85() => GetGuardians();
        internal static Bitmap smethod_86() => GetMinimizar();              // Minimizar button
        internal static Bitmap smethod_87() => GetMinimizarDown();          // Minimizar pressed
        internal static Bitmap smethod_88() => GetDeutsch();
        internal static Bitmap smethod_89() => GetEnglish();
        internal static Bitmap smethod_90() => GetEspanol();                // Aceptar/Aplicar button
        internal static Bitmap smethod_91() => GetFrench();                 // AceptarDown
        internal static Bitmap smethod_92() => GetItaliano();
        internal static Bitmap smethod_93() => GetKorean();
        internal static Bitmap smethod_94() => GetPaypal();                 // PayPal buttons
        internal static Bitmap smethod_95() => GetPolish();
        internal static Bitmap smethod_96() => GetPortBra();
        internal static Bitmap smethod_97() => GetRuso();
        internal static Bitmap smethod_98() => GetBarraLoad();
        internal static Bitmap smethod_99() => GetBoxZEN();
        internal static Bitmap smethod_100() => GetReload();                // BotonReload background
        internal static Bitmap smethod_101() => GetCharacterEX();
        internal static Bitmap smethod_102() => GetEditDefaults();
        internal static Bitmap smethod_103() => GetElfo();
        internal static Bitmap smethod_104() => GetFuego();
        internal static Bitmap smethod_105() => GetInf();
        internal static Bitmap smethod_106() => GetInventario();
        internal static Bitmap smethod_107() => GetLinckRed();
        internal static Bitmap smethod_108() => GetMark();
        internal static Bitmap smethod_109() => GetOFF();                   // BUpDate background
        internal static Bitmap smethod_110() => GetONN();                   // PictureBox2 image
        internal static Bitmap smethod_111() => GetPJ();
        internal static Bitmap smethod_112() => GetTablaItems();
        internal static Bitmap smethod_113() => GetDownloadMMK();
        internal static Bitmap smethod_114() => GetPaypal();
        internal static Bitmap smethod_115() => GetTMTBOX();
        internal static Bitmap smethod_116() => GetTMTLOGO();
        internal static Bitmap smethod_117() => GetUpDater();
        internal static Bitmap smethod_118() => GetVersion();
        internal static Bitmap smethod_119() => GetX();
        internal static Bitmap smethod_120() => GetXDown();
        #endregion
        internal static Bitmap smethod_65() => GetManual();
        internal static Bitmap smethod_66() => GetManualDown();
        internal static Bitmap smethod_67() => GetMinimizar();
        ...
        internal static Bitmap smethod_79() => GetPants();
        internal static Bitmap smethod_80() => GetBoots();
        internal static Bitmap smethod_81() => GetShields();
        internal static Bitmap smethod_82() => GetWings();
        internal static Bitmap smethod_83() => GetRings();
        internal static Bitmap smethod_84() => GetPendants();
        internal static Bitmap smethod_85() => GetGuardians();
        internal static Bitmap smethod_86() => GetArabe();
        internal static Bitmap smethod_87() => GetChino();
        internal static Bitmap smethod_88() => GetDeutsch();
        internal static Bitmap smethod_89() => GetEnglish();
        internal static Bitmap smethod_90() => GetEspanol();
        internal static Bitmap smethod_91() => GetFrench();
        internal static Bitmap smethod_92() => GetItaliano();
        internal static Bitmap smethod_93() => GetKorean();
        internal static Bitmap smethod_94() => GetLatviski();
        internal static Bitmap smethod_95() => GetPolish();
        internal static Bitmap smethod_96() => GetPortBra();
        internal static Bitmap smethod_97() => GetRuso();
        internal static Bitmap smethod_98() => GetBarraLoad();
        internal static Bitmap smethod_99() => GetBoxZEN();
        internal static Bitmap smethod_100() => GetCasilla();
        internal static Bitmap smethod_101() => GetCharacterEX();
        internal static Bitmap smethod_102() => GetEditDefaults();
        internal static Bitmap smethod_103() => GetElfo();
        internal static Bitmap smethod_104() => GetFuego();
        ...
        internal static Bitmap smethod_107() => GetLinckRed();
        internal static Bitmap smethod_108() => GetMark();
        internal static Bitmap smethod_109() => GetOFF();
        internal static Bitmap smethod_110() => GetONN();
        internal static Bitmap smethod_111() => GetPJ();
        internal static Bitmap smethod_112() => GetTablaItems();
        internal static Bitmap smethod_113() => GetDownloadMMK();
        internal static Bitmap smethod_114() => GetPaypal();
